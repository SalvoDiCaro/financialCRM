    ...
    <div class="box box-warning">
        <div class="box-header with-border">
            <div class="pull-right">
                <a class="btn btn-info btn-sm" href="{{ route('leads.edit', $lead->id) }}" title="Modifica"><i
                        class="fa fa-edit"></i></a>
                <a class="btn btn-warning btn-sm" href="
                @if (strpos(URL::previous(), 'instances') !== false)
                    ...
                    <div class="card col-md-6">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">
                                ...
                                <form action="{{ route('file.download', ['document' => $lead->document]) }}" method="POST"
                                ...
                                @else
                                    <form action="{{ route('file.upload', ['lead' => $lead->id]) }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
