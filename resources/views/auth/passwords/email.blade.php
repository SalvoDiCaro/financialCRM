...
<head>
  ...
  <!-- Bootstrap 3.3.6 -->
  <link rel="stylesheet" href="http://www.jfhmegami.com/admin/bootstrap/css/bootstrap.min.css">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.5.0/css/font-awesome.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="http://www.jfhmegami.com/admin/dist/css/AdminLTE.min.css">
  <!-- iCheck -->
	 ...
	 @if (session('status'))
      ...
      <div class="row">
        ...
        <div class="col-xs-4 pull-right">
          <button type="submit" class="btn btn-primary btn-block btn-flat">Invia link</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
...
<!-- jQuery 2.2.3 -->
<script src="http://www.jfhmegami.com/admin/plugins/jQuery/jQuery-2.2.3.min.js"></script>
<!-- Bootstrap 3.3.6 -->
<script src="http://www.jfhmegami.com/admin/bootstrap/js/bootstrap.min.js"></script>
<!-- iCheck -->
