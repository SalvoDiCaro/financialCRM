...
@section('content')
    ...
    @endif
    {!! Form::open(['method' => 'POST', 'route' => ['commitments.store']]) !!}
    @csrf
    ...
    <div class="box box-warning">
        <div class="box-header with-border">
            ...
            <h3 class="box-title"><strong>Nuova assegnazione dealer</strong></h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <div class="form-group">
                <strong>Dealer non assegnati:</strong>
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                    {!! Form::select('dealer_id', $dealers, null, ['class' => 'form-control']) !!}
                </div>
            </div>
            <div class="form-group">
